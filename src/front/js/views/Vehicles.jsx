                     ...
                     style={{height: '300px', width: '500px'}}/>
                        <div className="card-body mt-2">
                            ...
                            <div className="d-flex justify-content-between mt-5">
                                ...
                                <span onClick={() => { actions.addFavorites(item.uid)}} className="btn text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-heart button-heart-hover" viewBox="0 0 16 16">
